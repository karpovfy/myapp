    ...
    <form id="sfilter">
        <table class="table" id="tfilter">
            ...
            <tr>
                ...
                <th style="width:120px" class="text-info">Документ</th>
            ...
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm tf-pad">
                        <input type="text" class="form-control" id="docName" name="docname" placeholder="наименование">
                    </div>
                    <div class="input-group input-group-sm">
...
$(document).ready(function(){
    grd.jqGrid({ url:'/cabinet/allitemslist', datatype:'json',
        ...
        colModel:[
            ...
            {name:'exDeptName',index:'exDeptName',width:'440',sortable:true,title:false},
...
function loadGrid(){
    grd.setGridParam({page:1,url:'/cabinet/allitemslist?'+sfrm.serialize()}).trigger('reloadGrid');
}
