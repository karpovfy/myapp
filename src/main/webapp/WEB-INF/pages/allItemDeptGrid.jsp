    ...
    <form id="sfilter">
        <table class="table" id="tfilter">
            ...
            <tr>
                ...
                <th><strong class="text-danger" id="strongCnt"></strong> <a href="#" id="exportExcell"><span class="glyphicon glyphicon-floppy-save"></span></a></th>
            </tr>
            </thead>
            <tbody>
            <tr>
...
$(document).ready(function(){
    grd.jqGrid({ url:'/allboxopt/list', datatype:'json',
...
function loadGrid(){
    grd.setGridParam({page:1,url:'/allboxopt/list?'+sfrm.serialize()}).trigger('reloadGrid');
}
